...
public class ProcentoweActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_procentowe);
        ...
        obliczButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (masaSubRozpText.getText().toString().equals("") || masaRozpText.getText().toString().equals("")) {
                    Toast.makeText(ProcentoweActivity.this, "Wprowadź dane", Toast.LENGTH_SHORT).show();
                }else {
